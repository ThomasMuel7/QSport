...
def merge_csvs_from_leagues():
    ...
    leagues_folders = ['data/foot/Ligue_1', 'data/foot/Premier_League', 'data/foot/Bundesliga', 'data/foot/La_liga', 'data/foot/Serie_A']
    ranking_columns = [
    ...
    output_path = base_path / 'data' / 'foot' / 'whoScored.csv'
